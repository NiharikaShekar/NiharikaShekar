...
**Built with:** `JTokkit` `AWS EMR` `S3` `Lambda` `Terraform` `Hadoop` `Spark`
...
**Built with:** `Megatron-LM` `GPU Monitoring` `Emergency Checkpointing` `Python`
...
**Built with:** `Dart` `Firebase` `Android Studio` `Flutter`
